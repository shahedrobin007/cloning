...
---------------------------------------------
\033[1;96m|-------+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-----|
\033[1;96m|               cyber security broker               |
\033[1;96m|This Tool is Only for Bangladesh FB Acounts|
\033[1;96m|------+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+------|
\033[1;91m [⚡\033[1;97mAuthor Name: Shahed    ⚡\033[1;91m]
\033[1;91m [⚡\033[1;97mYutube Chnl:  cyber security broker ⚡\033[1;91m]
\033[1;91m [⚡       \033[1;97mFrom: Bangladesh     ⚡\033[1;91m]
\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mBlackhat\033[1;95m-_-_-_-_-_-_-_-_-»
"""
...
\033[1;92mNote2: This Tool is only for new_hacker
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Shahed
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;93mWrong Password"
            os.system('xdg-open https://.youtube.com/channel/UCQ2ca9nUd4tEC51Q1Y7BShg')
    else:
...
def menu():
	...
	print "\033[1;97m[3]\x1b[1;92mSubscribe cyber security broker Youtubee Channel " 
...
def pilih():
	...
	if unikers =="":
		...
		os.system('xdg-open https://m.youtube.com/channel/UCQ2ca9nUd4tEC51Q1Y7BShg')
	        menu()		
	elif unikers =="0":
		jalan('Token Removed')
		os.system('rm -rf login.txt')
...
def pilih():
	...
	if unikers =="":
		...
		os.system('xdg-open https://m.youtube.com/chchannel/UCQ2ca9nUd4tEC51Q1Y7BShg')
                menu()
	elif unikers =="0":
		jalan('Token Removed')
		os.system('rm -rf login.txt')
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print "\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mBlackhat\033[1;95m-_-_-_-_-_-_-_-_-»"
		print logo
   ...
   ::     ::         |         ::     ::
    ::     ::        |        ::     ::
     ...
     ^^      ::             ::      ^^
             ::             ::
             ^^             ^^
print "\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mshahed\033[1;95m-_-_-_-_-_-_-_-_-»"
